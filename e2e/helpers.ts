...
/**
 * A one-page AcroForm: a text field "fullname" (tooltip "Nome completo") and
 * a checkbox "agree" (tooltip "Concordo") whose on-state is /Yes. Written by
...
export function formPdf(name: string): string {
	...
	const source =
		'%PDF-1.7\n' +
		'1 0 obj << /Type /Catalog /Pages 2 0 R /AcroForm << /Fields [4 0 R 5 0 R] /DA (/Helv 0 Tf 0 g) /DR << /Font << /Helv 6 0 R >> >> >> >> endobj\n' +
		'2 0 obj << /Type /Pages /Kids [3 0 R] /Count 1 >> endobj\n' +
		'3 0 obj << /Type /Page /Parent 2 0 R /MediaBox [0 0 300 300] /Annots [4 0 R 5 0 R] >> endobj\n' +
		...
		'5 0 obj << /Type /Annot /Subtype /Widget /FT /Btn /T (agree) /TU (Concordo) /Rect [20 200 40 220] /P 3 0 R /V /Off /AS /Off /F 4 /AP << /N << /Yes 7 0 R /Off 8 0 R >> >> >> endobj\n' +
